...
const ActionSetter = (props) => {
  ...
  useEffect(() => {
    ...
    if (allAboutAction) setProfileTheme(allAboutAction.theme_element?.baseColor ? allAboutAction.theme_element?.baseColor : "#1e91cf")
    setVcardDetail(
    ...
    <div>
      ...
      >
        <Modal.Header closeButton className="px-5 pb-0">
          <Modal.Title>
            <h4 className="m-0">{renderHeader(whichAction)}</h4>
          </Modal.Title>
        </Modal.Header>
        <Modal.Body className="px-5">
          <p className="m-0">{renderActionDesctiption(whichAction)}</p>
          <Form>
          ...
          {!isNew ? (
            <>
              {!isDefault ? (
                <>
                  <Button
                    variant="danger"
                    size="sm"
                    onClick={() => deleteAction(allAboutAction.action_id)}
                  >
                    Delete action
                  </Button>
                  <Button
                    ...
                    onClick={() =>
                      makeDefaultAction(
                        allAboutAction.action_id,
                        allAboutAction.card_id,
                        allAboutAction.action_type_id
                      )
                    }
                  >
                    Make default
              ...
              <Button
                ...
                size="sm"
                onClick={() =>
                  modifyAction(allAboutAction.action_id, showModal, value)
                } //will value have the updated record?
              >
                Modify Action
              </Button>
            </>
            ...
            <Button
              variant="success"
              size="sm"
              onClick={() => addAction(showModal, value)}
            >
              Add Action
            </Button>
          )}
      ...
      >
        ...
        <Modal.Body className="px-5">
          <p className="m-0 mb-3">{renderActionDesctiption(whichAction)}</p>
          <Form>
            <Row>
              <Col md={4}>
                <FileUpload
              ...
              >
                ...
                {index ? (
                  <Col md={2}>
                    ...
                    >
                      <Icon nameIcon="BsTrash" propsIcon={{ size: 20 }} />
                    </Button>{" "}
                  </Col>
                ) : null}
                {/* </div> */}
          ...
          <Button
            className="mt-3 me-3 d-inline-flex align-items-center"
            variant="dark"
            size="sm"
            type="button"
            onClick={() => addFormFields(false)}
          >
            {" "}
            <span className="me-2">Add Link</span>
            <Icon nameIcon="BsFillBookmarkPlusFill" propsIcon={{ size: 16 }} />
          </Button>
          <Button
            ...
            size="sm"
            type="button"
            onClick={() => addFormFields(true)}
          >
            {" "}
            <span className="me-2">Add Action</span>
            <Icon nameIcon="BsSignpostFill" propsIcon={{ size: 20 }} />
          </Button>
        </Modal.Body>
        <Modal.Footer className="">

        <Row className="p-0 w-100">
            <Col md={6} className="theme-setter my-2">
              Choose theme
              <Button
                size="sm"
                className={profileTheme === "#1e91cf" ? "selected-button" : ""}
                onClick={() => setProfileTheme("#1e91cf")}
              >
                BLUE
              </Button>
              <Button
                size="sm"
                variant="dark"
                className={profileTheme === "#1e1e1e" ? "selected-button" : ""}
                onClick={() => setProfileTheme("#1e1e1e")}
              >
                DARK
              </Button>
            </Col>
            <Col md={6} className="p-0 my-2 d-flex justify-content-end gap-2">
              {!isNew ? (
                <>
                  {!isDefault ? (
                    <>
      ...
      >
        ...
        <Modal.Body className="px-5">
          ...
          <Button
            ...
            size="sm"
            type="button"
            onClick={() => addFormFields(2)}
          >
            {" "}
            <span className="me-2">Add Text Field</span>
            <Icon nameIcon="BsChatLeftQuoteFill" propsIcon={{ size: 20 }} />
          </Button>
        </Modal.Body>
        <Modal.Footer className="">
          <Row className="p-0 w-100">
